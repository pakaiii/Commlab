...
function changeText(){
    ...
    // innertext treats everything as text, links will not work here

}
function changeHTML(){
    headline.innerHTML = "This website is veryy <a herf='link here'>";

}
function changeStyle(){
    headline.style.color = "red";
    headline.style.backgroundColor = "black";
    // changes text color to red, background color of header to black
